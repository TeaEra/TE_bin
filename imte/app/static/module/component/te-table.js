                ...
                return (
                  React.createElement("tr", null, 
                      React.createElement("td", null, 
                          React.createElement("p", null, React.createElement("i", {className: "glyphicon glyphicon-chevron-right"}), " ", name)
                      ), 
                      React.createElement("td", null, 
                          React.createElement("p", null, React.createElement("a", {target: "_blank", href: link},  name ))
                      ), 
                      React.createElement("td", null, 
